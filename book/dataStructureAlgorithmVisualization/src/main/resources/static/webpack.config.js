...
module.exports = {
    ...
    entry: {
        ...
        'algorithm/pack01': './algorithm/pack01/start.js',
        'algorithm/reg': './algorithm/reg/start.js'
    },
    output: {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin(
            {
                template: './algorithm/reg/reg.html',
                chunks: ['commons', 'algorithm/reg'],
                filename: 'algorithm/reg/index.html'
            }
        ),
