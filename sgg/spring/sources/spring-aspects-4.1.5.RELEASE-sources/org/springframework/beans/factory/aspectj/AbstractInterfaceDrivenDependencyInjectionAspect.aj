...
public abstract aspect AbstractInterfaceDrivenDependencyInjectionAspect extends AbstractDependencyInjectionAspect {
	...
	public pointcut beanConstruction(Object bean) :
			initialization(org.springframework.beans.factory.aspectj.ConfigurableObject+.new(..)) && this(bean);
	...
	public pointcut beanDeserialization(Object bean) :
			execution(java.lang.Object ConfigurableDeserializationSupport+.readResolve()) && this(bean);

	public pointcut leastSpecificSuperTypeConstruction() : initialization(org.springframework.beans.factory.aspectj.ConfigurableObject.new(..));
