...
public class FileServerHandler extends SimpleChannelUpstreamHandler {
	...
	private void writeForm(MessageEvent e) {
		this.responseContent.setLength(0);
		...
		this.responseContent
			.append("<tr><td><input type=hidden name=\"" + Constants.USER_NAME_KEY + "\" value=\""
				+ Constants.DEFAULT_ACCOUNT.getUserName()
				+ "\" size=10></td></tr>");
		this.responseContent
			.append("<tr><td><input type=hidden name=\"" + Constants.PWD_KEY + "\" value=\""
