 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://server.jdk.mydemo.demo.com/", wsdlLocation = "http://192.168.0.107:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://server.jdk.mydemo.demo.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.107:8080/hello?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://server.jdk.mydemo.demo.com/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jdk.mydemo.demo.com/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
